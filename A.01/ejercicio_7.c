/*
Una vez que Chip y Dale por fin tienen un destino a donde ir, decidieron contarle a su amiga Gadget. Al escuchar los planes, 
se quiso sumar a sus vacaciones. Pero no le convencía el destino, por lo que tuvieron que hacer el sorteo nuevamente. 
Y para ser justos y que cada uno tenga la posibilidad de elegir, incorporaron como opción el mes de marzo y la vista 
de una laguna.
...
int main()
{
    ...
    if ((epoca == ENERO && paisaje == LAGUNA) ||
        ...
        (epoca == FEBRERO && paisaje == MONTANIA))
    {
        printf("Chip\n");
    }

    else if ((epoca == ENERO && paisaje == MONTANIA) ||
             (epoca == MARZO && paisaje == LAGUNA) ||
